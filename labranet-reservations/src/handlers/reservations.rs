...
pub async fn fetch_one_reservation(reservation_use_case:&State<Box<dyn ReservationUseCaseTrait>>,key:Result<JWT,ResponseError<String>>,reservation_id:String)->Result<String,Custom<String>>{
...
pub async fn update_reservation(reservation_use_case:&State<Box<dyn ReservationUseCaseTrait>>,key:Result<JWT,ResponseError<String>>,reservation:Json<ReservationModel>,reservation_id:String)->Result<String,Custom<String>>{
...
pub async fn delete_reservation(reservation_use_case:&State<Box<dyn ReservationUseCaseTrait>>,key:Result<JWT,ResponseError<String>>,reservation_id:String)->Result<String,Custom<String>>{
